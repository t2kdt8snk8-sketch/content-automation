...
## IMPORTANT: Codebase Intelligence Instructions for content-automation
...
Last indexed: 2026-04-22 (commit 4a5f673)
### Entry Points
- `claude-workspace-dashboard-template/server.py`
- `web/app.py`
- `free-claude-code/api/app.py`
- `minecraft-builder/src/App.jsx`
- `web/frontend/src/App.tsx`
- `claude-workspace-dashboard-template/start.sh`
- `free-claude-code/server.py`
- `main.py`
- `minecraft-builder/server/index.js`
- `minecraft-builder/src/main.jsx`
### Tech Stack
**Languages:** Python
...
|------|-------|-------------|-------|
| `content-automation/web/app.py` | 100.0th %ile | 3 | minsoo park |
| `web/app.py` | 99.9th %ile | 2 | minsoo park |
| `web/frontend/src/App.tsx` | 99.9th %ile | 4 | minsoo park |
| `content-automation/core/orchestrator.py` | 99.9th %ile | 3 | minsoo park |
| `core/orchestrator.py` | 99.9th %ile | 2 | minsoo park |
